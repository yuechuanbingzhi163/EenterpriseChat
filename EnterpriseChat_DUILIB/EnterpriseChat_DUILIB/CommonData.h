...
const TCHAR* const THREADQUITEVENT= _T("THREADQUITEVENT");

#define WM_CREATECHATDLG WM_USER+1000
#define WM_AFTERCLOSEMSG WM_USER+1001
...
typedef enum _UDPMSGTYPE
{
	...
	MULTICAST_SETMANAGER, //设置成群管理员
	MULTICAST_CACELMANAGER,//取消群管理员
	AUDIOMSG,              //语音消息
	VIDEOMSG               //视频消息
